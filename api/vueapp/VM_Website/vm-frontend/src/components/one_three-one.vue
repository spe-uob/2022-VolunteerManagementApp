<template>
	<div style="width: 100%;">
		...
		<div class="main" style="margin: 50px;">
			<el-form :model="formDate" label-position="left" label-width="200px">
				...
				<div style="position: fixed;bottom: 10px;z-index: 100;right: 20px;">
					<el-button class="btn"
						style="color: white;background-color: #aa0000;font-size: 12px;margin-right: 910px;"
						@click="Delete()">Delete
					</el-button>
		...
		<el-dialog :visible.sync="dialogVisible" width="90%">
			...
			<br />
			<span class="title1">
				Are you sure you want to delete the organisation "2"? All of the following related items will be
				deleted:
			</span>
			<br />
			<span class="title2">
			...
			<div style="margin-left: 40px;">
				<el-button class="btn" style="color: white;background-color: #aa0000;font-size: 12px;" @click="agree()">
					Yes,I'm sure
				</el-button>
				<el-button class="btn" style="color: white;background-color: rgb(79 141 171);font-size: 12px;"
