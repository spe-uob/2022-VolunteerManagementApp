        ...
        <div class="resident_container">
            <table class="Resident_table">
                ...
                <tr style="background-color: rgba(223, 226, 230, 1); height: 1.5rem;">
                    ...
                    <th @click="sortTable('TotalTimeReceived')">Total Time Received<span class="sortable1"
                                                                                         :class="{ active: activeButton === 4 }"></span>
                    </th>
                    <th @click="sortTable('Consent')">Consent<span class="sortable1"
                                                                   :class="{ active: activeButton === 5 }"></span></th>
                </tr>
                ...
                list: [
                    {
                        ...
                        LastName: 'LIU',
                        PhoneNumber: '123124',
                        Email: 'kf21667@bristol',
                        TotalTimeReceived: '10'
                    },
                    {
                        FirstName: 'Amy',
                        LastName: 'gIU',
                        PhoneNumber: '5',
                        Email: 'cf21667@bristol',
                        TotalTimeReceived: '4'
                    },
                    {
                        FirstName: 'dmy',
